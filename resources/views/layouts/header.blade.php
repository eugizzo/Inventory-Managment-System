...
<head>
    ...
    <link rel="" href="https://cdn.datatables.net/1.11.3/css/dataTables.bootstrap4.min.css">
            ...
            <div class="main-sidebar sidebar-style-2 py-4  ">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="flex">
                        ...
                        <div class="py-4">
                            <span class="font-semibold text-4xl tracking-tight z-20 font-italic text-white">Inventory_MS</span>
                            </span>
                        </div>
                    </div>
                    <ul class="sidebar-menu py-4" id="sidebar">
                        ...
                        <li class="dropdown {{Request::is('getLandingPage*')?'active':''}}">
                            <a href="{{route('getLandingPage')}}" class="nav-link"><i class="fa fa-tachometer-alt" aria-hidden="true"></i><span class="transition duration-700 ease-in-out">Dashboard</span></a>
                        </li>
