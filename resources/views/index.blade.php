...
<style>
  .background{  
          ...
          <p class="text-black text-xl  text-white">
            ...
            your products in real time to streamline your processes and increase efficiency in your daily operations
                ...
                <button class="rounded-md  py-12">
                  <a href="" class=" flex items-center shadow justify-center px-4  border border-transparent text-base font-medium rounded-md text-white bg-yellow-500 hover:bg-blue-600 md:py-3 md:text-lg md:px-8">
                  Read more
                  </a>
                </button>
        </div>
        ...
        <div class="container py-8">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading  px-32">
                        <h2 class="text-5xl">Our <em class="text-blue-600">Services</em></h2>
   ...
   <div class="text-center">
     <h1 class="text-5xl pt-10 pb-10 text-blue-600">Contact Us</h1>
   </div>
   <div class=" container mx-auto flex flex-wrap mb-16 justify-center mt-8 overflow-hidden">
     <div class="grid grid-cols-1 md:grid-cols-2">
       <div class="p-6 mr-2 bg-gray-100 bg-blue-600 sm:rounded-lg">
         ...
         <div class="flex items-center mt-8 text-white text-white">
