                        ...
                        <div class="card d:flex justify-content-between">
                            ...
                            @enderror
                                    ...
                                    <td class="col-lg-2">
                                        ...
                                        <input name="items[{{$index}}][purchasedQuantity]" 
                            wire:model="items.{{$index}}.purchasedQuantity" type="number" class="form-control">
                            ...
                            @enderror
                                    ...
                                    <td class="col-lg-2">
                                        ...
                                        <input name="items[{{$index}}][unityPrice]" 
                            wire:model="items.{{$index}}.unityPrice" type="number" class="form-control">
                            ...
                            @enderror
                                    ...
                                    <td class="col-lg-3">
                                        ...
                                        <input name="items[{{$index}}][supplier]" 
                            wire:model="items.{{$index}}.supplier" type="text" class="form-control">
